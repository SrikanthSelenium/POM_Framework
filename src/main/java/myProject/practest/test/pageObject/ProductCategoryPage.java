...
public class ProductCategoryPage {
	...
	public ProductCategoryPage(WebDriver driver) {
		...
		TestBase.logStatus("ProductCategoryPage object creatd...");
	...
	public void selectColor(String data){
		new JSExecutorHelper(driver).scrollIntoView(driver.findElement(By.xpath("//a[contains(text(),'"+data+"')]/parent::*/preceding-sibling::input[1]")));
	...
	public void selectFirstProduct() {
		...
		TestBase.logStatus("performning mouse over on first product of page..");
		obj.moveToElement(totalProducts.get(0)).build().perform();
		log.info("clicking on add to basket..");
		TestBase.logStatus("clicking on add to basket..");
		addToCart.click();
	}
