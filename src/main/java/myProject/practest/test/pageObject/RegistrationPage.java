...
import myProject.practest.test.helper.select.DropDownHelper;
...
public class RegistrationPage {
	...
	public void setDay(String day) {
		...
		while (itr.hasNext()) {
			...
			if (text.equals(day)) {
				TestBase.logStatus("selecting date as: " + day);
				c.click();
				break;
			}
		}
	...
	public void setMonth(String month) {
		...
		while (itr.hasNext()) {
			...
			if (text.equals(month)) {
				TestBase.logStatus("selecting month as: " + month);
				click.click();
				break;
			}
		}
	...
	public void setYear(String year) {
		...
		while (itr.hasNext()) {
			...
			String text = click.getText().trim();
			if (text.equals(year)) {
				TestBase.logStatus("selecting year as: " + year);
				click.click();
				break;
			}
		}
	...
	public void setYourAddressFirstName(String yourAddressFirstName) {
		...
		TestBase.logStatus("entering yourAddressFirstName.." + yourAddressFirstName);
	...
	public void setYourAddressLastName(String yourAddressLastName) {
		...
		TestBase.logStatus("entering yourAddressLastName.." + yourAddressLastName);
	...
	public void setYourAddressState(String yourAddressState) {
		...
		TestBase.logStatus("entering yourAddressState.." + yourAddressState);
		select.selectByVisibleText(this.yourAddressState, yourAddressState);

	}

	public void setYourAddressPostCode(String yourAddressPostCode) {
		log.info("entering yourAddressPostCode.." + yourAddressPostCode);
		TestBase.logStatus("entering yourAddressPostCode.." + yourAddressPostCode);
	...
	public void setAdditionalInformation(String additionalInformation) {
		...
		TestBase.logStatus("entering additionalInformation.." + additionalInformation);
		this.additionalInformation.sendKeys(additionalInformation);
	}

	public void setHomePhone(String homePhone) {
		log.info("entering homePhone.." + homePhone);
		TestBase.logStatus("entering homePhone.." + homePhone);
		this.homePhone.sendKeys(homePhone);
	}

	public void setMobilePhone(String mobilePhone) {
		log.info("entering mobilePhone.." + mobilePhone);
		TestBase.logStatus("entering mobilePhone.." + mobilePhone);
		this.mobilePhone.sendKeys(mobilePhone);
	}

	public void setAddressAlias(String addressAlias) {
		log.info("entering addressAlias.." + addressAlias);
		TestBase.logStatus("entering addressAlias.." + addressAlias);
		this.addressAlias.sendKeys(addressAlias);
	}

	public void clickRegistration() {
		log.info("clicked on registration.." + registration.getText());
		TestBase.logStatus("clicked on registration.." + registration.getText());
		registration.click();
	}
	...
	public boolean verifyRegisterSuccessMsg() throws Exception {
		return verifyHelper.isDisplayed(successMsgObject);
	}
	
	public String RegisterSuccessMsg() throws Exception {
